...
class NeuralNetwork{
    public:
        ...
        NeuralNetwork(vector<int> topology, int hiddenActivationType, int ouptutActivationType, int costFunctionType,
                        double bias = 1, double learningRate = 0.05, double momentum = 1);
